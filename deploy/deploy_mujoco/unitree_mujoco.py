...
def scroll_callback(window, xoffset, yoffset):
    mujoco.mjv_moveCamera(
        mj_model, mujoco.mjtMouse.mjMOUSE_ZOOM, 0, -0.05 * yoffset, scene, cam
    )
...
class ViewerHandle:
    ...
    def sync(self):
        ...
        mujoco.mjv_updateScene(
            mj_model, mj_data, opt, None, cam, mujoco.mjtCatBit.mjCAT_ALL, scene
        )
